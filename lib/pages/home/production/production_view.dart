...
import 'package:swbmobile/pages/home/production/detail_box_part.dart';
import 'scan_production.dart';

void main() => runApp(const MaterialApp(home: ProductionView()));
...
class ProductionView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Scan Label Per Box')),
      body: Center(
